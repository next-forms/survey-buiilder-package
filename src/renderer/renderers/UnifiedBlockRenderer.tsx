...
// Import legacy renderers that haven't been migrated yet
 ...
 */
export const UnifiedBlockRenderer = forwardRef<HTMLElement, BlockRendererProps>((props, ref) => {
  ...
  // Fall back to legacy renderers for blocks not yet migrated
  switch (block.type) {
    case 'textarea':
...
UnifiedBlockRenderer.displayName = 'UnifiedBlockRenderer';